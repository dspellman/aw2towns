...
public class TownManagerScreenHandler extends ScreenHandler {
    ...
    public static final int BUTTON_BLACKSMITH_MINUS = 10;
    public static final int BUTTON_BLACKSMITH_PLUS = 11;
    public static final int BUTTON_FARM_PRIORITY_MINUS = 12;
    public static final int BUTTON_FARM_PRIORITY_PLUS = 13;
    public static final int BUTTON_BAKER_PRIORITY_MINUS = 14;
    public static final int BUTTON_BAKER_PRIORITY_PLUS = 15;
    public static final int BUTTON_MINE_PRIORITY_MINUS = 16;
    public static final int BUTTON_MINE_PRIORITY_PLUS = 17;
    public static final int BUTTON_LUMBER_PRIORITY_MINUS = 18;
    public static final int BUTTON_LUMBER_PRIORITY_PLUS = 19;
    public static final int BUTTON_CARPENTER_PRIORITY_MINUS = 20;
    public static final int BUTTON_CARPENTER_PRIORITY_PLUS = 21;
    public static final int BUTTON_BLACKSMITH_PRIORITY_MINUS = 22;
    public static final int BUTTON_BLACKSMITH_PRIORITY_PLUS = 23;
